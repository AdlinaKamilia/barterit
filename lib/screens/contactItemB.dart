...
class ContactItemB extends StatefulWidget {
  final User user;
  ...
  @override
  State<ContactItemB> createState() => _ContactItemBState();
}

class _ContactItemBState extends State<ContactItemB> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: const Text("Buyer Item Details")),
        body: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                      ...
                      child: Card(
                        child: SizedBox(
                          ...
                          child: CachedNetworkImage(
                            ...
                            fit: BoxFit.cover,
                            imageUrl:
                                "${MyConfig().server}/barterit/assets/items/${widget.processItem.buyerItemId}_1.png",
                ...
                Text(
                  widget.processItem.buyerItemName.toString(),
                          ...
                          children: [
                            TableRow(children: [
                              ...
                              TableCell(
                                ...
                                child: Text(widget
                                    .processItem.buyerItemDescription
                                    .toString()),
                              ))
                            ]),
                            TableRow(children: [
                              ...
                              TableCell(
                                  child: Padding(
                                padding: const EdgeInsets.all(4.0),
                                child: Text(widget.processItem.buyerItemType
                                    .toString()),
                              ))
                            ]),
                            TableRow(children: [
                              ...
                              TableCell(
                                ...
                                padding: const EdgeInsets.all(4.0),
                                child: Text(
                                    widget.processItem.buyerItemQty.toString()),
                              ))
                            ]),
                            TableRow(children: [
                              const TableCell(
                              ...
                              TableCell(
                                ...
                                padding: const EdgeInsets.all(4.0),
                                child: Text(
                                    "RM ${double.parse(widget.processItem.buyerItemPrice.toString()).toStringAsFixed(2)}"),
                              ))
                            ]),
                            TableRow(children: [
                              const TableCell(
                              ...
                              TableCell(
                                ...
                                padding: const EdgeInsets.all(4.0),
                                child: Text(
                                    "${widget.processItem.buyerItemLocal}/${widget.processItem.buyerItemState}"),
                              ))
                            ]),
                            TableRow(children: [
                              const TableCell(
